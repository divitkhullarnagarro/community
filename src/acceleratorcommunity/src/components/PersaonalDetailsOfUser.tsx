                    ...
                    return (
                      <div className="specificLanguage" key={index}>
                        ...
                        <div onClick={() => props.filterLanguage(lang)}>
                          <img
                            className="cross"
                            src="https://cdn-icons-png.flaticon.com/32/10396/10396993.png"
                            alt="delete"
                          />
                        </div>
                      </div>
      ...
      <div className="personaleInformationContainer">
        ...
        <div className="fieldListContainer">
          ...
          <div className="fieldValue">
            {props?.tempUserData?.hobby?.map((hob: any, index: number) => {
              return (
                <div key={index} className="hobbyValue">
                  {hob}
                </div>
              );
            })}
        ...
        <div className="fieldListContainer">
          ...
          <div className="fieldValue">
            {props?.tempUserData?.language?.map((lang: any, index: number) => {
              return (
                <div key={index} className="languageValue">
                  {lang}
                </div>
              );
            })}
        ...
        <div className="fieldListContainer">
          ...
          <div className="fieldValue">
            {props?.tempUserData?.interests?.map((interest: any, index: number) => {
              return (
                <div key={index} className="interestValue">
                  {interest}
                </div>
              );
            })}
