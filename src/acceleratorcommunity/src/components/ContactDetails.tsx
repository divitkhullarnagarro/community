    ...
    <Modal show={props.showForm3} onHide={props.handleCloseForm3}>
      ...
      <Modal.Body className="modalForProfile">
        <Form>
          ...
          <span>
            {props.errorState?.phoneNumber ? <span className="error">Field is required</span> : ' '}
            {props.errorState?.phoneNoLength ? <span className="error">Length is greater than 10</span> : ' '}
    ...
    <Modal show={props.openLocationModalState} onHide={props.closeLocationMoadl}>
      ...
      <Modal.Body className="modalForProfile">
        <Form>
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            <Form.Label>ResidingFrom<span className="required">*</span></Form.Label>
            <Form.Control
              ...
              autoFocus
            />
            {props.errorState?.residingFrom ? <span className="error">Field is required</span> : ' '}
      ...
      <div className="personaleInformationContainer">
        ...
        <div className="ContactDeatils">
          <div className="emailConatiner">
            <div className="contactInfoTag">Email :</div>
            <div className="contactInfoTagValue">
              {props.showStateValue && props.tempUserData?.email}
            </div>
          </div>
          <div className="emailConatiner">
            <div className="contactInfoTag">Alt Email :</div>
            <div className="contactInfoTagValue">
          ...
          <div className="emailConatiner">
            <div className="contactInfoTag">Phone number :</div>
            <div className="contactInfoTagValue">
              ...
              <>
                {data?.leftAt === null ? (
                  <div>
                    ...
                    <div>
                      <div>residing from</div>
                      <div>{data?.residingFrom}</div>
                    </div>
                  </div>
                ) : (
                  ''
